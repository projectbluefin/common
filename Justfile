...
test:
    python3 -m pytest tests/test_hooks.py tests/test_check_oci_refs.py tests/test_curated_config.py tests/test_skill_docs.py tests/test_chairlift_config.py tests/test_render_hidamari_movie.py -v --cov=tests --cov-report=term-missing
