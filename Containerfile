...
RUN install -d /out/shared/usr/bin && \
    curl -fsSLo /out/shared/usr/bin/umotd https://github.com/theMimolet/umotd/releases/download/v0.2.1/umotd_0.2.1_linux_amd64 && \
    echo "2cd5a07344f553e590b432aa5b3a07c5cbd055487468d33514130ae5f05ba02e  /out/shared/usr/bin/umotd" | sha256sum -c && \
