...
RUN curl -fsSLo /tmp/game-devices-udev-1.0.tar.gz https://codeberg.org/fabiscafe/game-devices-udev/archive/1.0.tar.gz && \
  ...
  curl -fsSLo /tmp/70-u2f.rules https://raw.githubusercontent.com/Yubico/libfido2/refs/heads/main/udev/70-u2f.rules && \
    echo "eb5ab4db095e5bbc841b023ad3281a22f6d86fefccfaae06fc3f0e1db6cf8152  /tmp/70-u2f.rules" | sha256sum -c - && \
    install -Dpm0644 /tmp/70-u2f.rules /out/shared/usr/lib/udev/rules.d/70-u2f.rules
