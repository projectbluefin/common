...
Docs: *forgot to update docs/skills/ci-tooling.md*
...
# Examples:
# - Changed .github/workflows/* → update docs/skills/ci-tooling.md
# - Changed system_files/**    → update docs/skills/submodule-boundary.md or dconf-consistency.md
# - Changed Justfile           → update docs/skills/ci-tooling.md

# Edit the skill doc
vim docs/skills/ci-tooling.md

# Stage and commit
git add docs/skills/ci-tooling.md
...
|-----------|-----------|----------------|
| `.github/workflows/build.yml`, `validate.yml` | `ci-tooling.md` | CI/build pipeline |
| `.github/workflows/e2e*.yml`, test configs | `e2e-ci.md` | Post-merge testing |
| `system_files/shared/**` | `submodule-boundary.md` | Submodule boundary |
| `system_files/bluefin/etc/dconf/**`, `*.gschema.override` | `dconf-consistency.md` | dconf settings |
| `Justfile`, `*.just` | `ci-tooling.md` | Just recipes and local checks |
...
# 4. Stage both files
git add .github/workflows/build.yml docs/skills/ci-tooling.md

# 5. Commit together
git commit -m "feat(ci): add new build step

Also update ci-tooling.md skill doc to document new step."
