...
| 2026-06-21 | Image | Closed epic #546 (image diet + brew lifecycle): brew-preinstall infrastructure confirmed complete in common, system-cli.Brewfile package list current, issue closed. Downstream RPM removals for bluefin/lts/dakota and IME discussion remain as separate follow-up items. | common#546 |
